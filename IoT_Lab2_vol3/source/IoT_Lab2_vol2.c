...
void main_task(void *pvParameters) {
	...
	while (1) {
		...
		sprintf(g_bufferTX,"{\"air\":[{\"id\": 1, \"value\": %.1f}, {\"id\": 2, \"value\": %.1f},{\"id\": 3, \"value\":%.1f}]}", temperature, pressure/100, humidity);
		sprintf(g_sbuffer,"danielkrol.pwsztar.edu.pl/iot/lab/dev%02d/", deviceID);
		http_POST(g_sbuffer, g_bufferRX, g_bufferTX);
