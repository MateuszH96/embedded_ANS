...
/*! @name PIO1_4 (number 1), R78/P18[5]/LEDR/PWM_ARD
  @{ */
#define BOARD_INITMOTORSPINS_PWMA_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_PWMA_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_PWMA_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                           /* @} */

/*! @name PIO1_7 (number 9), R79/P18[7]/LEDG/PWM_ARD
  @{ */
#define BOARD_INITMOTORSPINS_PWMB_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_PWMB_PIN 7U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_PWMB_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                                           /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITMOTORSPINS_A2_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITMOTORSPINS_A2_GPIO_PIN_MASK (1U << 20U) /*!<@brief GPIO pin mask */
#define BOARD_INITMOTORSPINS_A2_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_A2_PIN 20U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_A2_PIN_MASK (1U << 20U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITMOTORSPINS_B1_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITMOTORSPINS_B1_GPIO_PIN_MASK (1U << 21U) /*!<@brief GPIO pin mask */
#define BOARD_INITMOTORSPINS_B1_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_B1_PIN 21U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_B1_PIN_MASK (1U << 21U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITMOTORSPINS_B2_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITMOTORSPINS_B2_GPIO_PIN_MASK (1U << 7U) /*!<@brief GPIO pin mask */
#define BOARD_INITMOTORSPINS_B2_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_B2_PIN 7U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_B2_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                                         /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITMOTORSPINS_A1_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITMOTORSPINS_A1_GPIO_PIN_MASK (1U << 6U) /*!<@brief GPIO pin mask */
#define BOARD_INITMOTORSPINS_A1_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITMOTORSPINS_A1_PIN 6U                   /*!<@brief PORT pin number */
#define BOARD_INITMOTORSPINS_A1_PIN_MASK (1U << 6U)      /*!<@brief PORT pin mask */
                                                         /* @} */
 ...
 *
 */
void BOARD_InitMotorsPins(void); /* Function assigned for the Cortex-M33 (Core #0) */
